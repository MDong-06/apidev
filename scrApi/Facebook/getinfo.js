...
exports.index = async (req, res, next) => {
  const axios = require("axios");
axios.get(`https://graph.facebook.com/${req.query.uid}?fields=id,is_verified,cover,created_time,work,hometown,username,link,name,locale,location,about,website,birthday,gender,relationship_status,significant_other,quotes,first_name,subscribers.limit(0)&access_token=EAAD6V7os0gcBAMCku6wrQBuQgF5xUC6iWfZCuJnE7rUBG5taX1KLJ67ZCr4XmJny8nCQHU903rtYD18CKUCyMrkHZAbdK4iCqcOFMsZBZA3d0bZACD7WeVVOOqXAljL4QVNZBs9dJdqA6Ntg2gA7JTZCvsjuxHUoG1b0eeuvdnOR6XS4R5wxMxk2`,{
        headers: {
